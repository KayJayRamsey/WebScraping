...
def scrape():
    ...
    news_p = elem.find('div', class_='article_teaser_body').get_text()
    ...
    df = tables[0] 
    html_table = df.to_html(classes="table tables-striped") 
    ...
    "def_tables": tables, "def_hemp_list": hemp_list, "def_url_list": url_list, "hemisphere_image_urls": hemisphere_image_urls} 
